...
if( is_admin() ||
    ...
    $plugin_requirements->requirements = array(
        ...
        'plugins' => array(
            array(
                'name'               => __('Phlox Core Elements', 'auxin-hubpost'), // The plugin name.
        ...
        'themes' => array(
            array(
                'name'                 => __('Phlox Pro', 'auxin-hubpost'), // The theme name.
