...
function auxin_push_metabox_models_hubpost( $models ){
    ...
    include_once( 'metabox-fields-hubpost-metadata.php'     );
    include_once( 'metabox-fields-hubpost-related.php'      );
    ...
    $models[] = array(
        'model'     => auxhp_metabox_fields_hubpost_metadata(),
        'priority'  => 8
    );
     $models[] = array(
        'model'     => auxhp_metabox_fields_hubpost_related_metadata(),
        'priority'  => 9
    );
...
add_filter( 'auxin_admin_metabox_models_hubpost', 'auxin_push_metabox_models_hubpost' );


/**
 * Removes sidebar layout options from hubpost metabox fields
 *
 * @param  array  $models The list of metabox models
 *
 * @return array  The list of filtered metabox models
 */
function auxin_hp_remove_sidebar_metabox_models( $models ){
    return auxin_remove_from_metabox_hub( $models, array( "field_ids" => array( "page_layout", "page_sidebar_style" ) ) );
}
add_filter( 'auxin_admin_metabox_models_hubpost', 'auxin_hp_remove_sidebar_metabox_models', 27, 1 );
