...
class AUXHP_Admin {
  ...
  private function includes(){
    include_once( AUXHP_ADMIN_DIR . '/includes/index.php' );
  }
  ...
  public static function get_instance() {
    ...
    if( apply_filters( 'auxhp_access_only_for_super_admins' , 0 ) && ! is_super_admin() ) {
      return;
    }
  ...
  public function enqueue_admin_scripts() {
    ...
    $admin_assets = new AUXHP_Admin_Assets();
...
return AUXHP_Admin::get_instance();
