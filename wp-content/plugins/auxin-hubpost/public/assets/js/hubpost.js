...
;(function($){
    // on document ready
    var filterList = $('.aux-widget-recent-hubposts .aux-ajax-filters li[data-filter]');

        filterList.on('click', function(e) {
            e.preventDefault();
            var $this   = $(this),
                $container = $this.parents('.aux-widget-recent-hubposts').find('.aux-ajax-view'),
                
                data = {
                    action  : 'aux_recent_hubpost_filter_content',
                ...
                $.post( auxhp.ajax_url, data, function(res){
