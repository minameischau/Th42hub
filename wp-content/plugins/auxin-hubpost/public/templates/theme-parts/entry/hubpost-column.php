<?php
    ...
    $classic_item_class_name = auxin_get_option( 'show_hubpost_entry_box_colors' ) ? 'aux-entry-boxed' : '';
                        ...
                        <article <?php post_class( $classic_item_class_name ); ?> >
                            <div class="<?php echo esc_attr( $hover_classes ); ?>">
                                ...
                                <div class="aux-overlay-content">
                                    <div class="aux-hubpost-overlay-buttons">
                            ...
                            <div class="entry-main">
                                ...
                                <div class="entry-read-more">
                                    ...
                                    <a href="<?php echo get_permalink( $post->ID );?>"><?php echo esc_html__( 'Read More', 'auxin-hubpost' );?></a>
                                    </span>
                                </div>
                                <?php } ?>
                            </div>
