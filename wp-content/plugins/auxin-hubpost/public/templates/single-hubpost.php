<?php
/**
 * The Template for displaying all single hubpost
 *
 * 
 * @package    Auxin
 * @license    LICENSE.txt
...
<?php
                        if ( have_posts() && ! $is_pass_protected ) :
                            ...
                            auxhp_get_template_part( 'theme-parts/single', get_post_type() );
                        ...
                        do_action( 'auxin_hubpost_single_after_article_primary', $post );
?>
                    </div><!-- end content -->
<?php              
...
?>
        ...
        <?php do_action( 'auxin_hubpost_single_after_content_primary', $post ); ?>
