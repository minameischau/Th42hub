...
function auxin_get_recent_hubposts_tiles_carousel_master_array( $master_array ) {

    $master_array['aux_recent_hubposts_tile_carousel'] = array(
        'name'                          => __('Recent Hubpost on Tile Carousel', 'auxin-hubpost' ),
        'auxin_output_callback'         => 'auxin_widget_recent_hubposts_tiles_carousel_callback',
        'base'                          => 'aux_recent_hubposts_tile_carousel',
        'description'                   => __('It adds recent hubpost items in tile carousel', 'auxin-hubpost' ),
        'class'                         => 'aux-widget-recent-hubposts aux-carousel',
        ...
        'params' => array(
            ...
            array(
                'heading'           => __('Number of hubposts to show in per page', 'auxin-hubpost'),
            ...
            array(
                'heading'           => __('Number of Pages', 'auxin-hubpost'),
                'description'       => '',
                'param_name'        => 'page',
                'type'              => 'textfield',
                'value'             => '2',
            ...
            array(
                ...
                'description'       => __('Number of post to displace or pass over.', 'auxin-hubpost' ),
                'param_name'        => 'offset',
                'type'              => 'textfield',
                'value'             => '',
                'holder'            => '',
            ...
            array(
                'heading'          => __('Post tile style','auxin-hubpost' ),
                'description'      => '',
                ...
                'edit_field_class' => '',
                'value'             => array(
                   'darken'          => __('Dark', 'auxin-hubpost'),
                   'lighten'         => __('Light', 'auxin-hubpost'),
                ),
            ),
            array(
                'heading'           => __('Navigation control', 'auxin-hubpost'),
                'description'       => '',
            ...
            array(
                'heading'          => __('Button Navigation Style','auxin-hubpost' ),
                'description'      => '',
            ...
            array(
                'heading'           => __('Loop navigation','auxin-hubpost' ),
                'description'       => '',
            ...
            array(
                'heading'           => __('Autoplay carousel','auxin-hubpost' ),
                'description'       => '',
            ...
            array(
                'heading'           => __('Autoplay delay','auxin-hubpost' ),
...
add_filter( 'auxin_master_array_shortcodes', 'auxin_get_recent_hubposts_tiles_carousel_master_array', 10, 1 );
 ...
 */
function auxin_widget_recent_hubposts_tiles_carousel_callback( $atts, $shortcode_content = null ){
    ...
    $default_atts = array(
        ...
        'loadmore_per_page'           => '',
        'base_class'                  => 'aux-widget-recent-hubposts aux-carousel'
    );
    ...
    switch ( $item_style ) {
        ...
        default:
            ...
            $hover_classes = '';
            $show_lightbox = false;
            $tamplate_file = 'hubpost-column';
    }

    $container_class    = 'aux-hubpost-columns master-carousel aux-no-js aux-mc-before-init aux-tile-' . esc_attr( $tile_skin ) . ' ';
    ...
    if( $have_posts ){
        ...
        while ( $wp_query->have_posts() ) {
            ...
            <?php
            include auxin_get_template_file( 'theme-parts/entry/hubpost', $tamplate_file, AUXHP()->template_path() );?>
