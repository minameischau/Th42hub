...
/**
 * Elementor 'Recent_Hubposts_Masonry' widget.
 *
 * Elementor widget that displays an 'Recent_Hubposts_Masonry' with lightbox.
 *
 * @since 1.0.0
 */
class Recent_Hubposts_Masonry extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve 'Recent_Hubposts_Masonry' widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'aux_recent_hubposts_masonry';
    }

    /**
     * Get widget title.
     *
     * Retrieve 'Recent_Hubposts_Masonry' widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return __('Masonry Hubposts', 'auxin-hubpost' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve 'Recent_Hubposts_Masonry' widget icon.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register 'Recent_Hubposts_Masonry' widget controls.
     *
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'loadmore_per_page',
            array(
                'label'     => __('Load More Per Page', 'auxin-hubpost' ),
                'type'      => Controls_Manager::NUMBER,
                'default'   => '',
                'condition' => array(
                    'paginate!' => 'yes'
