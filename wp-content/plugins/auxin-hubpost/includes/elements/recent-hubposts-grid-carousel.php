 ...
 */
function auxin_widget_recent_hubposts_grid_carousel_callback( $atts, $shortcode_content = null ){
    ...
    $default_atts = array(
        ...
        'item_style'                  => 'classic',
        'perpage'                     => 10,
        'carousel_navigation_control_text_next' => __('Next', 'auxin-hubpost'),
        'carousel_navigation_control_text_prev' => __('Previous', 'auxin-hubpost') , 
        'preloadable'                 => false,
        ...
        'loadmore_label'              => 'text',
        'loadmore_per_page'           => '',
        'base'                        => 'aux_recent_hubposts_grid_carousel',
        'base_class'                  => 'aux-widget-recent-hubposts-carousel'
    );
    ...
    $items_classes      = 'aux-hubpost-carousel aux-hubpost-columns master-carousel aux-no-js aux-mc-before-init' . ' aux-' . $carousel_nav_control_pos . '-control';
